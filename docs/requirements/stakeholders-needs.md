...
Цей документ надає детальний огляд сценаріїв із зазначенням учасників, передумов, 
результатів та можливих винятків для кожного з них. 
Кожен сценарій містить унікальну назву та перелік етапів,
що відображають послідовність дій під час його реалізації. 
Окрім цього, документ описує користувачів системи, їхні ролі, 
функціональні можливості та вимоги до системи. Він дозволяє краще зрозуміти,
як система для аналізу медіа-контенту взаємодіятиме з користувачами та вирішуватиме задачі, 
пов'язані з аналізом медіа-даних.
...
**Аналітика** [[3]](#link3) - це процес збирання, обробки та аналізу даних 
...
**Обліковий запис користувача** [[4]](#link4) - це персональний профіль в інформаційній системі
...
**Автоматизація** [[5]](#link5) - це процес використання технологій для виконання завдань
...
**Валідація** [[6]](#link6) - це процес перевірки правильності та відповідності введених даних
...
3. <a name="link3" href="https://uk.wikipedia.org/wiki/%D0%90%D0%BD%D0%B0%D0%BB%D1%96%D1%82%D0%B8%D0%BA%D0%B0">Аналітика</a>
4. <a name="link4" href="https://www.silverfort.com/glossary/user-account/#:~:text=A%20user%20account%20is%20an%20account%20assigned%20to%20an%20individual,user's%20role%20and%20job%20responsibilities.">Обліковий запис користувача</a>
5. <a name="link5" href="https://www.ibm.com/topics/automation">Автоматизація</a>
6. <a name="link6" href="https://www.digital-ls.de/en/glossar/validation/">Валідація</a>
