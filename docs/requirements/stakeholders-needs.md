...
| **ВИКЛЮЧНІ СИТУАЦІЇ:** | • Користувач не має прав на редагування медіа-контенту - PermissionDeniedException <br/> • Медіа-контенту з таким ідентифікатором не існує - InvalidContentIdException • Оновлені дані не проходить валідацію - InvalidContentDataException |
